---
name: backlog-md
description: Manage project work with the Backlog.md CLI, including tasks, acceptance criteria, Definition of Done checklists, docs, decisions, search, and board views while preserving metadata sync. Use when creating, viewing, searching, editing, implementing, or closing Backlog.md tasks, or when a project contains backlog/tasks, backlog/docs, or backlog/decisions and the user asks about tickets, acceptance criteria, task status, project docs, or backlog workflow.
---
