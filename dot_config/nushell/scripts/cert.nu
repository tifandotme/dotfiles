...
export def "cert dates" [domain: string] {
...
export def "cert check" [domain: string] {
...
export def "cert issuer" [domain: string] {
  ""
...
export def "cert finger" [domain: string] {
...
export def "cert decode" [path: path] {
